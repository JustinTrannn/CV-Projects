...
while True:
    ...
    if result.face_landmarks:
        for face_landmarks in result.face_landmarks:
            ...
            # ---- Point 1
            if not point_1_done:
                cv2.circle(image, (10, 10), 3, (0, 0, 0), 3)
                cv2.putText(image, "Look at point 1/5 and press c to calibrate", (100, 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 255, 0))
                if key == ord('c'):
                    x_coordinates.append([LI_1_x, LI_2_x, LI_3_x, LI_4_x, LI_avg_x, RI_1_x, RI_2_x, RI_3_x, RI_4_x, RI_avg_x])
                    y_coordinates.append([LI_1_y, LI_2_y, LI_3_y, LI_4_y, LI_avg_y, RI_1_y, RI_2_y, RI_3_y, RI_4_y, RI_avg_y])
                    x_true.append([10])
                    y_true.append([10])
                    point_1_done = True
            # ---- Point 2
            elif not point_2_done:
                cv2.circle(image, (10, h-10), 5, (0, 0, 0), 3)
            ...
            # ---- Point 3
                ...
                cv2.circle(image, (w // 2, h // 2), 5, (0, 0, 0), 3)
            ...
            # ---- Point 4
                ...
                cv2.circle(image, (w-10, 10), 5, (0, 0, 0), 3)
            ...
            # ---- Point 5
                ...
                cv2.circle(image, (w-10, h-10), 5, (0, 0, 0), 3)
...
model_x.fit(x_coordinates, x_true)
model_y.fit(y_coordinates, y_true)
...
while True:
    ...
    if result.face_landmarks:
        for face_landmarks in result.face_landmarks:
            ...
            x_predictions = model_x.predict([[LI_1_x, LI_2_x, LI_3_x, LI_4_x, LI_avg_x, RI_1_x, RI_2_x, RI_3_x, RI_4_x, RI_avg_x]])[0][0]
            y_predictions = model_y.predict([[LI_1_y, LI_2_y, LI_3_y, LI_4_y, LI_avg_y, RI_1_y, RI_2_y, RI_3_y, RI_4_y, RI_avg_y]])[0][0]

            cv2.circle(image, (int(x_predictions), int(y_predictions)), 5, (255, 255, 255), 3)
